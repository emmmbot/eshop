	...
	<div id="box_autoplay">
    	<div class="list">
        	<ul>
            	...
            	<li><img src="${pageContext.request.contextPath }/client/images/ad/index_ad4.jpg" width="900" height="335" /></li>
            	<li><img src="${pageContext.request.contextPath }/client/images/ad/index_ad5.jpg" width="900" height="335" /></li>
        	</ul>
    	</div>
	</div>
	<!-- 商场首页轮播图  end -->
