...
<HEAD>
	...
	function d_confirm(id,tnum) {
		if(tnum.length>0) {
			if(confirm("当前已有运单号，确定更新？")==true) {
				d_confirm(id,'')
			}
			else return;
		}
			...
			if (msg == ''||msg==null) {
				...
				window.location.href = "${pageContext.request.contextPath}/confirmDeliver?id="+id+"&trackingnum="+msg;
			}
			return
		}
...
<body>
	<table cellSpacing="1" cellPadding="5" width="100%" align="center"
		...
		<tr>
			...
			<td class="ta_01" bgColor="#ffffff">${order.ordertime}</td>
			<td align="center" bgColor="#f5fafe" class="ta_01">运单号：</td>
			<td class="ta_01" bgColor="#ffffff">${order.trackingnumber }</td>
		</tr>
		<TR>
		...
		<TR>
			<td class="ta_01" style="WIDTH: 100%" align="middle" bgColor="#f5fafe" colSpan="4">
				<FONT face="宋体">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</FONT>
				<c:if test="${order.paystate!=0}">
					<INPUT class="button_ok" type="button" onclick="d_confirm('${order.id}','${order.trackingnumber}')" value="确认发货" />
				</c:if>
